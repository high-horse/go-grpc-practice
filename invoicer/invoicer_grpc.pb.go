...
const (
	HelloWorldService_SayHelloWorld_FullMethodName = "/helloworld.HelloWorldService/SayHelloWorld"
)
...
func (c *helloWorldServiceClient) SayHelloWorld(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	...
	err := c.cc.Invoke(ctx, HelloWorldService_SayHelloWorld_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloWorldServiceServer) SayHelloWorld(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error) {
...
func _HelloWorldService_SayHelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloWorldService_SayHelloWorld_FullMethodName,
	}
