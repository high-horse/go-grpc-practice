...
const (
	WeatherService_GetWeatherUpdates_FullMethodName = "/weather.WeatherService/GetWeatherUpdates"
)
...
func (x *weatherServiceGetWeatherUpdatesClient) Recv() (*WeatherResponse, error) {
...
func (x *weatherServiceGetWeatherUpdatesServer) Send(m *WeatherResponse) error {
